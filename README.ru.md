...
**[🇬🇧 In English](README.md)** · [Открыть каталог →](https://fivol.github.io/lectorea/)

### Что учить и в каком порядке

Lectorea — бесплатный каталог университетских видеокурсов с YouTube: лекционные
плейлисты настоящих вузов, разложенные не по алфавиту, а по тому, что чему
предшествует. Почти 200 курсов в 39 областях знания, и каждый знает, на что он
опирается.

Этим он и отличается от поиска: YouTube найдёт лекцию по тензорному анализу, но
...
**Мелочи, которые приятны.** Светлая и тёмная темы, ссылка, которая переносит
ровно тот вид, что вы видите, и горячие клавиши (`/` — поиск, `t` — тема, `?` —
весь список).
