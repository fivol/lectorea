...
цифрами: часы просмотра, лекции и курсы позади, и путь ко всему избранному —
одной полосой.
...
остановились, лекции и курсы позади и то, сколько осталось до ближайшей цели:
одно нажатие, чтобы продолжить, второе — чтобы открыть профиль.
